...
# 配置
SESSION_NAME="Kaptive_run"
SCRIPT_PATH="/home/luolintao/0_Github/13-A.baumannii/4-注释/6-荚膜多糖/script/1-Kaptive.sh"
LOG_FILE="/data_raid/7_luolintao/1_Baoman/1-Assemble/NCBI_Sequence/Kaptive_run.log"
