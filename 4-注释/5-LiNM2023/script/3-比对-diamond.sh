...
VFDB_DB="/home/luolintao/0_Github/13-A.baumannii/4-注释/5-LiNM2023/data/biocide_resistance.translated"
OUT_DIR="/data_raid/7_luolintao/1_Baoman/1-Assemble/NCBI_Sequence/生物杀灭抵抗"
...
python3 /home/luolintao/test_mail.py "4-注释/5-LiNM2023/script/3-比对-diamond.sh任务完成通知" "<p>4-注释/5-LiNM2023/script/3-比对-diamond.sh分析已完成，请查看结果目录。</p>"
