...
YUZHI_DIR="/data_raid/7_luolintao/1_Baoman/1-Assemble/NCBI_Sequence/毒力因子/阈值"
TEMP_COMBINED="${YUZHI_DIR}/combined_virulence_data.csv"
OUTPUT_FILE="/data_raid/7_luolintao/1_Baoman/1-Assemble/NCBI_Sequence/All_Samples_毒力因子_阈值.csv"
